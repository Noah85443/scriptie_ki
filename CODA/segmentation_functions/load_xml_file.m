...
function explore_structure(structure, depth)
    % Explore the structure recursively and display field names and values
    if nargin < 2
        depth = 0;
    end
    ...
    for i = 1:length(fields)
        ...
        disp([repmat('  ', 1, depth), fieldname]);

        if isstruct(fieldvalue)
            explore_structure(fieldvalue, depth + 1);
        end
    end
end
